...
<template>
  <div class="tc-about page-card">
    ...
    <section class="tc-about-section">
      <p class="tc-about-byline">Built by <a href="https://github.com/ammul" target="_blank" rel="noopener">ammul</a> - lazy music fan.</p>
    </section>

    <section class="tc-about-section">
      <a href="https://github.com/ammul/tonarium" target="_blank" rel="noopener" class="btn btn-sm btn-subtle tc-about-github-btn">
