...
describe('Card', () => {
  it('renders default slot content in card-body', () => {
    ...
    expect(wrapper.find('.tc-card-body').exists()).toBe(true)
    expect(wrapper.find('.test-content').exists()).toBe(true)
  })

  it('renders title when provided', () => {
    const wrapper = mount(Card, { props: { title: 'My Title' } })
    expect(wrapper.find('.tc-card-title').text()).toBe('My Title')
  })

  it('does not render card-header when no title and no header slot', () => {
    const wrapper = mount(Card)
    expect(wrapper.find('.tc-card-header').exists()).toBe(false)
  })
  ...
  it('renders header slot and overrides title', () => {
    ...
    expect(wrapper.find('.tc-card-header').exists()).toBe(true)
    expect(wrapper.find('.custom-header').exists()).toBe(true)
    expect(wrapper.find('.tc-card-title').exists()).toBe(false)
  })
